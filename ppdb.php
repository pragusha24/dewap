...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ppdb (nama_lengkap, alamat, jenis_kelamin, tanggal_lahir, email, nomor_telepon, program_pendidikan)
            VALUES ('$nama_lengkap', '$alamat', '$jenis_kelamin', '$tanggal_lahir', '$email', '$nomor_telepon', '$program_pendidikan')";

    if ($conn->query($sql) === TRUE) {
        $notifikasi = "Pendaftaran berhasil!";
    } else {
        $notifikasi = "Terjadi kesalahan: " . $conn->error;
    }
}
...
<head>
    ...
    <title>Pendaftaran PPDB - PKBM NURUL IMAN</title>
...
<body>
    <header>
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="ppdb.php" class="active">PPDB</a></li>
    ...
    <?php if (isset($_SESSION['username'])): ?>
        <section class="ppdb">
            <h2>Pendaftaran PPDB PKBM NURUL IMAN</h2>
